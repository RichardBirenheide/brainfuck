...
public class BfBreakpoint extends LineBreakpoint implements IBfBreakpoint {
	...
	public static final String MARKER_TYPE = BfActivator.BUNDLE_SYMBOLIC_NAME + ".brainfuckBreakpointMarker";
	public static final String ID = BfActivator.BUNDLE_SYMBOLIC_NAME + ".brainfuckBreakpoint";
